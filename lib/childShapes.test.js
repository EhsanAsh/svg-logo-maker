...
describe("Square", () => { 
  ...
  describe("instantiate", () => { 
    ...
    it("should be an instance of Square", () => {
      const square = new Square("abc", "red", "#ffffff", "rgb(210, 105, 30)", 100);
  ...
  describe("side", () => { 
    ...
    it("should set the side properly", () => {
      const side = 100;
      const square = new Square("abc", "red", "#ffffff", "rgb(210, 105, 30)", side);
      expect(square.side).toBe(side);
    });

    it("should throw an error when the side provided is not a number", () => { 
      const side = "abc";
      expect(() => new Square(side)).toThrow("Please enter a valid side");
    });

    it("should throw an error when the side provided is undefined", () => { 
