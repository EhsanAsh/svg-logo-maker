...
class Shape { 
  ...
  // Used(https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial/Introduction) as a reference for the SVG syntax.
  render() {
    const { shapeColor, bgColor } = this;
    return `
    <svg version="1.1" width="100%" height="50%" xmlns="http://www.w3.org/2000/svg">
      <rect x="40%" y="50%" width="300" height="200" fill="${bgColor}" stroke-width="2" stroke="${shapeColor}"/>
      {{CHILD-CONTENT}}
    `;
  };
